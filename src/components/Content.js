        ...
        <div className="w-100 flex  px-10 py-10 ">
            ...
            <div className="btns">
                <div className="upperbtn">
                    <button onClick={myadd} name="Exp" className="upbtn btnexp">Exp</button>
                    <button onClick={myadd} name="sqrt" className="upbtn btnsqrt">Sqrt</button>
                    ...
                    <button onClick={myadd} name="" className="upbtn  btnx">1/x</button>
                    <button onClick={myadd} name="" className="upbtn btnxp">x^2</button>
                ...
                <div className="lowerbtn">
                    ...
                    <button onClick={myadd} name="%" className="lowbtn btnmod">%</button>
                    <button onClick={calculate} name="equal" className="bg-green-600 lowbtn btneq">=</button>
                </div>
            </div>
            </div>
            <script>
